...
const standardGet = client => key => new Promise((resolve, reject) => {
...
const standardDel = client => key => new Promise((resolve, reject) => {
    client.del(key, err => {
...
export const redis = client => {
    return {
        ...
        set: (key, value, ex = 5) => new Promise((resolve, reject) => {
