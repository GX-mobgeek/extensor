# Extensor
[![Build Status](https://travis-ci.org/GX-mobgeek/extensor.svg?branch=master)](https://travis-ci.org/GX-mobgeek/extensor) [![JavaScript Style Guide](https://img.shields.io/badge/code_style-standard-brightgreen.svg)](https://standardjs.com)
...
withAuth( ioServer,
    ...
    (response) => {
        ...
        // response( /* status of authentication */, /* atachs a prop in socket object */ )
        return response(true, { userId: '123' })
        // in .on('connection') the socket object contains [userId] = 123
    }
)
...
const customAdapter = {
    ...
    set: (key, value, expire = false) => new Promise((resolve, reject) => {
